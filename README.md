...
Transcripts are automatically generated by uploading audio or video files to the `uploads` bucket created below in the Setup step. The service automatically extracts audio from video files and transcribes it using the Whisper AI model.
